...
🔹 Previously interned at **Celebal Technologies** as a React Developer.  
...
> Role-based authentication, scalable REST APIs, and Nodemailer integration.
...
> Engineered **encrypted sessions, JWT authentication, and auto-submission workflows**.
...
> Optimized RESTful APIs for image pipelines and deployed on **Render** with high availability.
...
- Core contributor to **production-grade full-stack web applications**  
- Built **AI-powered recruitment automation** and **proctored examination systems**  
- End-to-end ownership: frontend, backend APIs, authentication, deployment  

### 🔹 Celebal Technologies  
**React Developer Intern** — *May 2025 – Jun 2025*  
- Developed reusable UI components in **React.js + TailwindCSS**  
- Integrated REST APIs and optimized rendering performance  

### 🔹 WsCube Tech (Campus Program)  
**Full Stack Web Development Trainee** — *Feb 2023 – Feb 2024*  
- Hands-on MERN stack training with **real-world projects**  
- API design, DB modeling, and cloud deployment
...
[![Portfolio](https://img.shields.io/badge/Portfolio-ujjwalkumarsahni.netlify.app-00C7B7?style=flat&logo=netlify)](https://ujjwalkumarsahni.netlify.app)
